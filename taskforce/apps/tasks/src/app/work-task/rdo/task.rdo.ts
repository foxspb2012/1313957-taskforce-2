...
export class TaskRdo {
  ...
  @ApiProperty({
    ...
    example: '51599d01-9abe-4794-9375-ec720c70f042',
  })
  @Expose()
  clientId: string;
  ...
  @ApiProperty({
    description: 'Task client ID',
    example: '31e42365-5502-4328-9233-5b2fe994909f',
  })
  @Expose()
  contractorId: string;
